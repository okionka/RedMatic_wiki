...
* [Universelles Accessory, Einbinden von nicht-Homematic Geräten](#universal-accessory)
  * [Beispiel ContactSensor](#beispiel-contactsensor)
  * [Beispiel TemperatureSensor](#beispiel-temperaturesensor)
...
**Hinweis:** Damit Events von Tasten in Node-RED ankommen muss https://github.com/rdmtc/RedMatic/wiki/Faq#Tastendruck-erzeugt-keine-Events beachtet werden.
