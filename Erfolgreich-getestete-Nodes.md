* [node-red-contrib-alexa-local](https://flows.nodered.org/node/node-red-contrib-alexa-local) - Port Konflikt mit ssdpd, Workaround siehe [Issue #15](https://github.com/hobbyquaker/RedMatic/issues/15)
